            ...
            try
            {
                using (var x = OpenDB())
                {
                    ...
                    return await x.ExecuteAsync(DbQuery.SettingNew, new
                    {
                        ...
                        propinsi = data.setting_province,
                        kabupaten = data.setting_kabupaten,
                        kecamatan = data.setting_kecamatan,
                        kelurahan = data.setting_kelurahan,
                        address = data.setting_address,
                        postal = data.setting_postalcode,
