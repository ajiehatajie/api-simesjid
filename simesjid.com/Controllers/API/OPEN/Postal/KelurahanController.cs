...
namespace simesjid.com.Controllers.API.OPEN.Postal
{
    ...
    public class KelurahanController : Controller
    {
        ...
        public KelurahanController(ILoggerManager logger)
        {

            _logger = logger;
        }

        [HttpGet(Name = "GetOpenKelurahan")]
        public IActionResult Index(PagingParams pagingParams)
        {
            try
            {
                ...
                objResponse = PostalServices.GetAllKelurahan(pagingParams);
                ...
                var response = new PostalModelOutput
                {
                    ...
                    Pagination = GetLinks(objResponse, "GetOpenKelurahan")
